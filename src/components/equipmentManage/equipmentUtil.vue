        ...
        <el-tabs v-model="tabActive" @tab-click="getData">
            ...
            <el-tab-pane label="润滑卡片" name="lubricatingCards">
                ...
                <el-table :data="[1]" v-if="data!=='detail'" style="width: 100%">
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input v-model="lubricatingCard.oilSpecifications" placeholder="油品型号"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input v-model="lubricatingCard.initialOilAmount" placeholder="初装油量"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input v-model="lubricatingCard.standardOilAmount" placeholder="标准油量"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input v-model="lubricatingCard.lubricatingPeriod" placeholder="润滑周期"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
