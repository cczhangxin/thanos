<template>
    <div class="item-box">
        ...
        <header class="header-search">
            <el-input size="small" v-model="equipmentNumber" placeholder="请输入设备编号" clearable
                      style="width: 180px;"></el-input>
            <el-input size="small" v-model="equipmentName" placeholder="请输入设备名称" clearable
                      style="width: 180px;"></el-input>
        ...
        <el-table :data="tableData" style="width: 100%" height="620" v-loading="loading" element-loading-text="拼命加载中">
            ...
            <el-table-column label="操作" width="350">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="primary" @click="handleEquipmentInfo(scope.$index, scope.row)">新增固定资产
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="dialogTitle" :visible.sync="showDialog" width="60%" :close-on-click-modal="false"
            ...
            <!--基础信息-->
            <el-form v-show="stepActive===0" :model="basicInformation" :rules="ruleBasicInformation"
            ...
            <div v-show="stepActive===1">
                ...
                <el-table :data="[1]" style="width: 100%">
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="squarePart.installLocation" placeholder="使用部位"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="squarePart.specifications" placeholder="规格型号"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="squarePart.initialAmount" placeholder="装机数量"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="squarePart.technicalParameters" placeholder="技术参数"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
            ...
            <div v-show="stepActive===2">
                <el-table :data="lubricatingCards" style="width: 100%">
                    ...
                    <el-table-column label="操作" width="150">
                        <template slot-scope="scope">
                            <el-button size="mini" type="success" @click="dialog=true;activeData=scope.row">修改
                            </el-button>
                            <el-button size="mini" type="danger" @click="deleteItem(scope.row)">删除</el-button>
                        </template>
                    </el-table-column>
                ...
                <el-table :data="[1]" style="width: 100%">
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.position" placeholder="润滑部位"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.amount" placeholder="润滑点数"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.type" placeholder="润滑方式"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.oilSpecifications" placeholder="油品型号"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.initialOilAmount" placeholder="初装油量"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.supplyOilAmount" placeholder="加油量"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.lubricatingPeriod" placeholder="润滑周期"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="lubricatingCard.temperature" placeholder="标准温度"
                                      clearable></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column width="150">
